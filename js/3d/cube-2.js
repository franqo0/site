...
const cube1Container = document.getElementById("cube-2");
...
// Punto de luz
const light = new THREE.PointLight('#FFFFFF', 0, 600)
...
// Rotar modelo
    const factorRotation = -0.005
        model.rotation.x += factorRotation -0.01
